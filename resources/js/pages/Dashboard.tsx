                                        ...
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className={`whitespace-nowrap px-2 py-1 rounded text-[10px] font-bold uppercase 
                                                ${bp.status === 'over' ? 'bg-rose-50 text-rose-500 dark:bg-rose-500/10 dark:text-rose-400' : 
                                                  bp.status === 'empty' ? 'bg-rose-50 text-rose-500 dark:bg-rose-500/10 dark:text-rose-400' :
                                                ...
                                                {bp.status === 'over' ? 'Bocor' : bp.status === 'empty' ? 'Habis' : bp.status === 'warning' ? 'Hampir Habis' : bp.status === 'nobudget' ? 'Tanpa Anggaran' : 'Aman'}
                                            </span>
                                        </div>
                                        <div className="w-full bg-bgray-100 dark:bg-darkblack-500 rounded-full h-1.5">
                                            <div className={`${bp.status === 'over' || bp.status === 'empty' ? 'bg-rose-500' : bp.status === 'warning' ? 'bg-orange-500' : bp.status === 'nobudget' ? 'bg-gray-400' : 'bg-success-300'} h-1.5 rounded-full`} style={{ width: `${pct}%` }}></div>
                                        </div>
